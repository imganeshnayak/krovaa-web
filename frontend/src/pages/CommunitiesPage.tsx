    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif" }} className="min-h-screen bg-[#F5F5F5] text-[#1C1C1C] pb-20">
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#E0E0E0] pb-6">
          <div>
            ...
            <p className="text-sm text-[#1C1C1C]/60">Work together with teams, share projects, and collaborate in community spaces.</p>
          </div>
          <Button 
        ...
        <div className="grid grid-cols-3 gap-4 rounded-2xl border border-[#E0E0E0] bg-white p-4 shadow-sm">
          <div className="text-center sm:text-left sm:pl-4">
            <span className="block text-[10px] font-bold uppercase tracking-wider text-[#1C1C1C]/40">Communities</span>
          ...
          <div className="text-center sm:text-left border-l border-[#E0E0E0] pl-4">
            <span className="block text-[10px] font-bold uppercase tracking-wider text-[#1C1C1C]/40">Public Communities</span>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 rounded-[2rem] border-2 border-dashed border-[#E0E0E0] bg-white p-8">
            ...
            <h3 className="text-base font-bold text-[#1C1C1C] mb-1">No communities found</h3>
            <p className="text-xs text-[#1C1C1C]/50 max-w-sm mx-auto mb-6">
              {searchQuery ? `No communities matching "${searchQuery}"` : 'Create the first community to start collaborating.'}
            </p>
              ...
              >
                ...
                <div className="pt-3 border-t border-slate-50 flex items-center justify-between text-[11px] font-medium text-[#1C1C1C]/40">
                  <div className="flex gap-3">
                    ...
                    <span>•</span>
                    <span>{community.projectCount || 0} Projects</span>
                  </div>
      ...
      <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
        <DialogContent className="sm:max-w-md bg-white border border-[#E0E0E0] rounded-[2rem] p-6">
          <DialogHeader>
            <DialogTitle className="text-lg font-bold text-[#1C1C1C] tracking-tight">Create New Community</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-[#1C1C1C]/40">Community Name</label>
              <Input 
                placeholder="e.g. Web Developers India" 
                value={newName} 
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-[#1C1C1C]/40">Description</label>
              <Input 
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xs font-bold text-[#1C1C1C]">Private Community</span>
                <span className="text-[10px] text-[#1C1C1C]/50 mt-0.5">Members must be approved by the creator to join.</span>
              </div>
            </div>
          </div>
